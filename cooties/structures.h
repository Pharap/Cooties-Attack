...
// Size of a square bullet
constexpr uint8_t bulletSize = 3;

// Maximum number of bullets
constexpr uint8_t bullets = 5;

// Minimum frames between firing
constexpr uint8_t bulletWait = 10;

// "Bullet not in use" value;
constexpr int bulletOff = -1;

// Maximum number of target
constexpr uint8_t maxTargets = 5;
uint8_t targets = 4;
uint8_t maxLife = 3;
